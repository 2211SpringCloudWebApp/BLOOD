				...
				<tfoot>
					<tr>
						<td>
							...
							</form> <c:if test="${loginUser.memberType eq 0 && loginUser ne null}">
...
<body style="margin-top : 120px;" cz-shortcut-listen="true">
	...
	<div id="kakaoIndex">
		<!-- 웹접근성용 바로가기 링크 모음 -->
		<a href="/board/faq.bld">본문 바로가기</a>
	</div>
	<div id="kakaoWrap">
		<div id="kakaoHead" role="banner">
			<div class="inner_head">
				<h1 class="tit_logo">
					<a class="tit_notice link_windows" href="/board/faq.bld"> <span
						...
						<ul class="list_notice">
							...
							<li><a class="link_notice"
								href="/faq/detail.bld?faqNo=${faq.faqNo }"> <strong
									class="tit_item">${faq.faqTitle } </strong> <span
